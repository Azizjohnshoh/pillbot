...
💊 Dorilar soni: {total}",
        ...
        "voice_off": "🔇 Ovozli eslatmalar o'chirildi",
        "confirm_delete": "Dori oʻchirildi."
    },
    "ru": {
        "greeting": "👋 Здравствуйте! Добро пожаловать в бот напоминаний о лекарствах!",
        "start_menu": "Выберите пункт меню:",
        "ask_med_name": "💊 Введите название лекарства (например: Парацетамол)",
        "ask_time": "⏰ Когда принимаете? Выберите или введите сами:",
        "ask_custom_time": "🕐 Пожалуйста, введите время в формате HH:MM (например: 18:45)",
...
💊 Количество лекарств: {total}",
        ...
        "voice_off": "🔇 Голосовые уведомления отключены",
        "confirm_delete": "Напоминание удалено."
    }
}
